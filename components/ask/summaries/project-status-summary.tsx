...
export function ProjectStatusSummaryView({
  ...
  const rows: [string, keyof ProjectStatusSummaryT, "text" | "date"][] = [
    ...
    ["Open commitments", "open_commitment_count", "text"],
    ["At-risk commitments", "at_risk_commitment_count", "text"],
    ["Open risks", "open_risk_count", "text"],
    ["Open deviations", "open_deviation_count", "text"],
    ["Next milestone", "next_milestone_name", "text"],
    ["Next milestone due", "next_milestone_planned_at", "date"],
  ];
